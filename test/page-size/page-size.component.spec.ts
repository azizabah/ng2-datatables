...
describe('PageSizeComponent', () => {
    ...
    it('should have template with select and 0 options',
        inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
            tcb
                .createAsync(PageSizeComponent)
                .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
    ...
    it('should have template with select and some options',
        inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
            tcb
                .createAsync(PageSizeComponent)
                .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
    ...
    it('should react to change of pageSize',
        inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
            tcb
                .createAsync(PageSizeComponent)
                .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
    ...
    describe('change pageSizeArray', () => {

        it('pageSize exists in new pageSizeArray',
            inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
                tcb
                    .createAsync(PageSizeComponent)
                    .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
        ...
        it('pageSize don\'t exists in new pageSizeArray',
            inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
                tcb
                    .createAsync(PageSizeComponent)
                    .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
    ...
    describe('change pageSize & pageSizeArray', () => {
        ...
        it('pageSize doesn\'t exists in pageSizeArray',
            inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
                tcb
                    .createAsync(PageSizeComponent)
                    .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
    ...
    xdescribe('labels prefix & sufix', () => {
        ...
        it('should be possible to change values',
            inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
                tcb
                    .createAsync(PageSizeComponent)
                    .then((componentFixture: ComponentFixture<PageSizeComponent>) => {
